const categories = [
  {
    ...
    children: ["Skin Care", "Hair Care", "Nail Care", "Makeup"],
    status: "show",
    products: 120,
    description:
  ...
  },
  {
    ...
    children: ["Baby Food", "Diapers", "Baby Skin Care", "Baby Health"],
    status: "show",
    products: 200,
    description:
  ...
  },
  {
    ...
    children: ["Vitamins", "Supplements", "Pain Relief", "Herbal Capsules"],
    status: "show",
    products: 150,
  ...
  },
  {
    ...
    children: ["Moisturizers", "Serums", "Face Masks", "Anti-Aging"],
    status: "show",
    products: 180,
    description:
  ...
  },
  {
    ...
    children: ["Sanitary Pads", "Tampons", "Feminine Wash", "Intimate Care"],
    status: "show",
    products: 100,
  ...
  },
  {
    ...
    children: ["Bandages", "Antiseptics", "Thermometers", "Pain Relief"],
    status: "show",
    products: 60,
    description:
  ...
  },
  {
    ...
    children: ["Vitamins", "Supplements", "Weight Loss", "Fitness"],
    status: "show",
    products: 200,
    description:
  ...
  },
  {
    ...
    children: ["Toothpaste", "Toothbrushes", "Mouthwash", "Dental Floss"],
    status: "show",
    products: 80,
    description:
  ...
  },
  {
    ...
    children: ["Body Care", "Shaving & Grooming", "Hand Care", "Foot Care"],
    status: "show",
    products: 150,
  ...
  },
  {
    ...
    children: ["Bandages", "Surgical Gloves", "Scalpels", "Sutures"],
    status: "hide",
    products: 50,
    description:
